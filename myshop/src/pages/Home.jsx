...
export default function Home() {
    ...
    const outlets = [
  {
    ...
    description: "Our flagship store, oldest in the market since 1970, serving you with quality products. Get everything for your household here—from hosiery to crockery, all under one roof!",
    photo: "images/GH.png",
  ...
  },
  {
    ...
    description: "Opened in 2011, Gupta Luggage offers a wide variety of stylish and durable bags. Perfect for every occasion and lifestyle, available at the cheapest rates in the market and online!",
    photo: "images/GL.png",
  ...
  },
  {
    ...
    description: "Our newest store, specializing in modern and unique kitchen appliances and crockery you won't find anywhere else. Affordable, high-quality products for all your household needs, available both in-store and online.",
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <header className="bg-indigo-600 text-white py-6 rounded-lg text-center space-y-4">
        ...
        <p className="mt-2 text-lg md:text-xl">  Quality products for your home and lifestyle{" "}
  <span className="font-semibold text-yellow-400">— Since 1970</span></p>
...
<div className="space-y-6 mt-6">
  <h2 className="text-2xl md:text-3xl font-bold text-center text-indigo-600 relative inline-block group cursor-pointer">
    Our Outlets
    <span className="absolute left-0 -bottom-1 w-0 h-1 bg-indigo-600 transition-all group-hover:w-full"></span>
  </h2>
        ...
        {offers.map((offer) => (
          ...
          >
            <div className="relative h-40 w-full overflow-hidden rounded mb-2">
              ...
              />
              <div className="absolute inset-0 bg-black bg-opacity-20 opacity-0 group-hover:opacity-100 transition duration-300 flex items-center justify-center text-white text-center p-2 rounded">
    ...
    {showForm && (
      ...
      <div ref={contactRef} className="bg-gray-100 p-6 rounded-lg mt-12 space-y-4">
        ...
        <div className="max-w-md mx-auto space-y-2">
          <p><strong>Phone:</strong> 9415071592</p>
          <p><strong>Email:</strong> sanjay1971.rbl@gmail.com</p>
          <p><strong>Address:</strong> Kaiper Ganj, Kotwali Road, Rae Bareli</p>
        </div>
      </div>
    </div>
  );
